...
namespace ImGui
{
    ...
    IMGUI_API void          RenderTextOverlay(ImVec2 pos, const char* text, const char* text_end, bool hide_text_after_hash);
    ...
    IMGUI_API void RenderColorRectWithAlphaCheckerboard(ImVec2 p_min, ImVec2 p_max, ImU32 col, float grid_step, ImVec2 grid_off, float rounding =0, int rounding_corners_flags = 0);

    // Widgets low-level behaviors
    IMGUI_API bool          ButtonBehavior(const ImRect& bb, ImGuiID id, bool* out_hovered, bool* out_held, ImGuiButtonFlags flags = 0);
    IMGUI_API bool TabButtonEx(const char* label, int number, bool* active, const ImVec2& size_arg, bool some_wiki_wiki_stuff);
    ...
    IMGUI_API bool SubTabEx(const char* label, bool* active, const ImVec2& size_arg, ImGuiButtonFlags flags);

    IMGUI_API bool          SubTab(const char* label, bool active, const ImVec2& size_arg = ImVec2(0, 0));

    IMGUI_API bool TabEx(const char* label, int number, bool* active, const ImVec2& size_arg, ImGuiButtonFlags flags);
    ...
    // InputText
    IMGUI_API bool InputTextEx(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data);
