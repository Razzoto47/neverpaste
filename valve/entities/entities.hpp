...
namespace nem::valve {
	...
	public:
		...
		__forceinline std::string get_weapon_name ( )
		{
			...
			switch ( weapon_index )
			{
				case e_item_index::revolver: str_result =  ( "Revolver R8" ); break;
				case e_item_index::scar20: str_result =  ( "SCAR20" ); break;
				case e_item_index::deagle: str_result =  ( "Deagle" ); break;
				case e_item_index::elite: str_result =  ( "Dual elite" ); break;
				case e_item_index::fiveseven: str_result =  ( "Fiveseven" ); break;
				case e_item_index::frag_grenade: str_result =  ( "Frag grenade" ); break;
				case e_item_index::smoke_grenade: str_result =  ( "Smoke grenade" ); break;
				case e_item_index::decoy: str_result =  ( "Decoy grenade" ); break;
				case e_item_index::flashbang: str_result =  ( "Flashbang" ); break;
				case e_item_index::hkp2000: str_result =  ( "P2000" ); break;
				case e_item_index::inc_grenade: str_result =  ( "Fire grenade" ); break;
				case e_item_index::molotov: str_result =  ( "Molotov" ); break;
				case e_item_index::he_grenade: str_result =  ( "Frag grenade" ); break;
		...
		__forceinline std::string get_weapon_icon ( )
		{
			...
			{
				case e_item_index::scar20: str_result =  ( "Y" ); break;
				case e_item_index::g3sg1: str_result =  ( "X" ); break;
				case e_item_index::awp: str_result =  ( "Z" ); break;
				case e_item_index::ssg08: str_result =  ( "a" ); break;
				case e_item_index::deagle: str_result =  ( "A" ); break;
				case e_item_index::revolver: str_result =  ( "J" ); break;
				case e_item_index::hkp2000: str_result =  ( "E" ); break; break;
				case e_item_index::glock: str_result =  ( "D" ); break;
				case e_item_index::usp_silencer: str_result =  ( "G" ); break;
				case e_item_index::elite: str_result =  ( "B" ); break;
				case e_item_index::c4: str_result =  ( "o" ); break;
				case e_item_index::p250: str_result =  ( "F" ); break;
				case e_item_index::aug: str_result =  ( "U" ); break;
				case e_item_index::fiveseven: str_result =  ( "C" ); break;
				case e_item_index::ak47: str_result =  ( "W" ); break;
				case e_item_index::galil: str_result =  ( "Q" ); break;
				case e_item_index::cz75a: str_result =  ( "I" ); break;
				case e_item_index::famas: str_result =  ( "R" ); break;
				case e_item_index::tec9: str_result =  ( "H" ); break;
				case e_item_index::bizon: str_result =  ( "M" ); break;
				case e_item_index::m249: str_result =  ( "g" ); break;
				case e_item_index::negev: str_result =  ( "f" ); break;
				case e_item_index::nova: str_result =  ( "e" ); break;
				case e_item_index::mag7: str_result =  ( "d" ); break;
				case e_item_index::taser: str_result =  ( "h" ); break;
				case e_item_index::he_grenade: str_result =  ( "j" ); break;
				case e_item_index::smoke_grenade: str_result =  ( "k" ); break;
				case e_item_index::frag_grenade: str_result =  ( "n" ); break;
				case e_item_index::molotov: str_result =  ( "l" ); break;
				case e_item_index::sawedoff: str_result =  ( "c" ); break;
				case e_item_index::decoy: str_result =  ( "m" ); break;
				case e_item_index::flashbang: str_result =  ( "i" ); break;
				case e_item_index::m4a1: str_result =  ( "S" ); break;
				case e_item_index::m4a1_silencer: str_result =  ( "T" ); break;
				case e_item_index::firebomb: str_result =  ( "k" ); break;
				case e_item_index::mac10: str_result =  ( "K" ); break;
				case e_item_index::ump45: str_result =  ( "L" ); break;
				case e_item_index::mp7: str_result =  ( "N" ); break;
				case e_item_index::p90: str_result =  ( "P" ); break;
				case e_item_index::mp9: str_result =  ( "N" ); break;
				case e_item_index::sg553: str_result =  ( "V" ); break;
				case e_item_index::xm1014: str_result =  ( "e" ); break;
				case e_item_index::ta_grenade: str_result =  ( "i" ); break;
			}
	...
	public:
		...
		__forceinline void modify_eye_pos ( vec3_t& eye_pos, valve::bones_t& bones )
		{
			...
			auto head_bone = lookup_bone (  ( "head_0" ) );
