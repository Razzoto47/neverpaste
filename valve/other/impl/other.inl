...
namespace nem::valve {
    ...
    __forceinline void bf_write_t::write_user_cmd( user_cmd_t* to, user_cmd_t* from ) {
        auto address = g_context->addresses( ).m_write_user_cmd.get( );
        auto i_cant_code = reinterpret_cast< uint32_t >( this );
