...
namespace nem::hacks {
	...
	{
		static const auto& net_var = valve::g_net_vars->entry (  ( "CCSPlayer->m_flVelocityModifier" ) );

		valve::data_map_t* data_map = valve::g_local_player->get_pred_desc_map ( );
		valve::type_description_t* type_desc = valve::g_local_player->get_data_map_entry ( data_map,  ( "m_chief_keef" ) );
	...
	{
		static const auto& net_var = valve::g_net_vars->entry (  ( "CCSPlayer->m_flThirdpersonRecoil" ) );

		valve::data_map_t* data_map = valve::g_local_player->get_pred_desc_map ( );
		valve::type_description_t* type_desc = valve::g_local_player->get_data_map_entry ( data_map,  ( "m_bitch_love_sosa" ) );
