...
namespace nem::hacks {
	...
	private:
        ...
        struct cfg_t {
            ...
            // Players
            float m_flNameColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bName = false;

            float m_flHealthColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bHealth = false;

            float m_flBoxColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bBox = false;

            bool m_bFlags = false;

            float m_flHitMarkerColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bHitMarker = false;

            float m_flWeaponIconColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bWeaponIcon = false;

            float m_flWeaponTextColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bWeaponText = false;

            float m_flAmmoColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bAmmo = false;

            float m_flSkeletonColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            bool m_bSkeleton = false;

            float m_flOOFArrowsColor[ 4 ] = { 1.f, 1.f, 1.f, 1.f };
            ...
            bool m_bEnableLogger = false;

            bool m_bHitsound = false;
            bool m_bSpectators = false;
            bool m_bKeybinds = false;
            bool m_bBombIndicator = true;
            bool m_bWatermark = true;
