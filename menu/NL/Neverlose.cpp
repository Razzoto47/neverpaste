...
void C_Nl::Draw( LPDIRECT3DDEVICE9 pDevice, bool bState )
{
    ...
    // main
    ImGui::GetForegroundDrawList( )->AddRectFilled( ImVec2( m_iMenuPosX + 234 + 1, m_iMenuPosY ), ImVec2( m_iMenuPosX + 235 + 3, m_iMenuPosY + 871 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 24.f, 24.f, 24.f, 255.f * ImGui::GetStyle( ).Alpha ) ), 13.0f );
    ImGui::GetForegroundDrawList( )->AddRectFilled( ImVec2( m_iMenuPosX + 234 + 1, m_iMenuPosY + 88 ), ImVec2( m_iMenuPosX + 235 + 762, m_iMenuPosY + 91 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 24.f, 24.f, 24.f, 255.f * ImGui::GetStyle( ).Alpha ) ), 13.0f );
   
    // user info
    ImGui::GetForegroundDrawList( )->AddRectFilled( ImVec2( m_iMenuPosX + 234 + 1, m_iMenuPosY + 788 ), ImVec2( m_iMenuPosX + 1, m_iMenuPosY + 790 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 24.f, 24.f, 24.f, 255.f * ImGui::GetStyle( ).Alpha ) ), 13.0f );

    if ( sizeof( m_pIcons[IC_AVATAR] ) < 0 )
        ImGui::GetForegroundDrawList( )->AddCircleFilled( ImVec2( m_iMenuPosX + 45, m_iMenuPosY + 830 ), 25.f, ImGui::ColorConvertFloat4ToU32( RGB_VEC( 255.f, 255.f, 255.f, 255.f * ImGui::GetStyle( ).Alpha ) ) );
    else
        ImGui::GetForegroundDrawList( )->AddImage( m_pIcons[IC_AVATAR], ImVec2( m_iMenuPosX + 20, m_iMenuPosY + 805 ), ImVec2( m_iMenuPosX + 70, m_iMenuPosY + 855 ), ImVec2( 0, 0 ),  ImVec2( 1, 1 ),  ImGui::ColorConvertFloat4ToU32( ImVec4( 1.f, 1.f, 1.f, ImGui::GetStyle().Alpha ) ) );
    
    if ( g_worker->username.size( ) < 18 )
        ImGui::GetForegroundDrawList( )->AddText( ImVec2( m_iMenuPosX + 82, m_iMenuPosY + 811 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 225.f, 225.f, 225.f, 255.f * ImGui::GetStyle( ).Alpha ) ), g_worker->username.c_str( ) );
    else
        ImGui::GetForegroundDrawList( )->AddText( ImVec2( m_iMenuPosX + 82, m_iMenuPosY + 811 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 225.f, 225.f, 225.f, 255.f * ImGui::GetStyle( ).Alpha ) ), "..." );

    ImGui::GetForegroundDrawList( )->AddText( ImVec2( m_iMenuPosX + 82, m_iMenuPosY + 831 ), ImGui::ColorConvertFloat4ToU32( RGB_VEC( 225.f, 225.f, 225.f, 255.f * ImGui::GetStyle( ).Alpha ) ), "Expires: ~Never" );
    MoveWindows( );
