...
void OnOpenCfgFolder( ) {
    const auto path = std::filesystem::path{ "neverlose" };

    std::filesystem::create_directory( "neverlose" );
...
void C_Nl::InitializeElements( )
{
    CALL_ONCE_START;
    {
        ...
        ADD_ELEMENT( C_Element( ).WindowBegin( "Tabs", ImVec2( m_iMenuPosX, m_iMenuPosY ), ImVec2( 237, 871 ), RGB_VEC( 26.f, 25.f, 28.f, 220.f ), ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar, true ) );
        {
            constexpr float flOffsetX = 0.f;
            constexpr float flOffsetY = -6.f;

            ADD_ELEMENT( C_Element( ).Text( "NEVERLOSE", ImVec2( flOffsetX + 13.f, flOffsetY + 29.f ), RGB_VEC( 6.f, 65.f, 97.f, 255.f ), pLogoFont ) );
            ADD_ELEMENT( C_Element( ).Text( "NEVERLOSE", ImVec2( flOffsetX + 14.f, flOffsetY + 30.f ), RGB_VEC( 4.f, 141.f, 206.f, 255.f ), pLogoFont ) );
            ADD_ELEMENT( C_Element( ).Text( "NEVERLOSE", ImVec2( flOffsetX + 15.f, flOffsetY + 31.f ), RGB_VEC( 255.f, 255.f, 255.f, 255.f ), pLogoFont ) );
            ...
            ADD_ELEMENT( C_Element( ).Tab( ImVec2( 28.f, 500.f + 33.f + 44.f ), m_pIcons[IC_INVENTORY], ImVec2( 20.f, 18.f ), "Skinchanger", &m_iSelectedTab, 8 ) );
        ...
        ADD_ELEMENT( C_Element( ).WindowBegin( "Main", ImVec2( m_iMenuPosX + 235, m_iMenuPosY ), ImVec2( 762, 871 ), RGB_VEC( 8.f, 8.f, 8.f, 255.f ), ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse, true ) );
        {
            ...
            ADD_ELEMENT ( C_Element ( ).ChildBegin ( "Main ", ImVec2 ( 28, 116 ), ImVec2 ( 352, 269 ), false, 0 ) );
            {
                ...
                ADD_ELEMENT ( C_Element ( ).Checkbox ( _h ( "CB_KNIFEBOT" ), "Knifebot", CHILD_ELEMENT_POS ( 2 ), &nem::hacks::g_aim_bot->cfg ( ).m_bKnifebot ) );
                ADD_ELEMENT ( C_Element ( ).Checkbox ( _h ( "CB_AUTO_SCOPE" ), "Auto Scope", CHILD_ELEMENT_POS ( 3 ), &nem::hacks::g_aim_bot->cfg ( ).m_bAutoScope ) );
            ...
            // Players
            ADD_ELEMENT( C_Element( ).ChildBegin( "ESP   ", ImVec2( 28, 116 ), ImVec2( 352, 558 ), false, 2 ) );
            {
                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 0 ), nem::hacks::g_aim_bot->cfg ( ).m_flNameColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_NAME" ), "Name", CHILD_ELEMENT_POS( 0 ), &nem::hacks::g_aim_bot->cfg ( ).m_bName ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 1 ), nem::hacks::g_aim_bot->cfg ( ).m_flHealthColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_HEALTH" ), "Health", CHILD_ELEMENT_POS( 1 ), &nem::hacks::g_aim_bot->cfg ( ).m_bHealth ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 2 ), nem::hacks::g_aim_bot->cfg ( ).m_flBoxColor ) );
                ...
                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 4 ), nem::hacks::g_aim_bot->cfg ( ).m_flHitMarkerColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_HIT_MARKER" ), "Hit Marker", CHILD_ELEMENT_POS( 4 ), &nem::hacks::g_aim_bot->cfg ( ).m_bHitMarker ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 5 ), nem::hacks::g_aim_bot->cfg ( ).m_flWeaponIconColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_WEAPON_ICON" ), "Weapon Icon", CHILD_ELEMENT_POS( 5 ), &nem::hacks::g_aim_bot->cfg ( ).m_bWeaponIcon ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 6 ), nem::hacks::g_aim_bot->cfg ( ).m_flWeaponTextColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_WEAPON_TEXT" ), "Weapon Text", CHILD_ELEMENT_POS( 6 ), &nem::hacks::g_aim_bot->cfg ( ).m_bWeaponText ) );
                
                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 7 ), nem::hacks::g_aim_bot->cfg ( ).m_flAmmoColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_AMMO" ), "Ammo", CHILD_ELEMENT_POS( 7 ), &nem::hacks::g_aim_bot->cfg ( ).m_bAmmo ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 8 ), nem::hacks::g_aim_bot->cfg ( ).m_flSkeletonColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_SKELETON" ), "Skeleton", CHILD_ELEMENT_POS( 8 ), &nem::hacks::g_aim_bot->cfg ( ).m_bSkeleton ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 9 ), nem::hacks::g_aim_bot->cfg ( ).m_flOOFArrowsColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_OOF_ARROW" ), "OOF Arrow", CHILD_ELEMENT_POS( 9 ), &nem::hacks::g_aim_bot->cfg ( ).m_bOOFArrows ) );

                ADD_ELEMENT( C_Element( ).ColorPicker( 263.f, CHILD_ELEMENT_POS( 11 ), nem::hacks::g_aim_bot->cfg ( ).m_flGlowColor ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_GLOW" ), "Glow", CHILD_ELEMENT_POS( 11 ), &nem::hacks::g_aim_bot->cfg ( ).m_bGlow ) );
            }
            ADD_ELEMENT( C_Element( ).ChildEnd( false, 2 ) );

            ADD_ELEMENT( C_Element( ).ChildBegin( "Chams     ", ImVec2( 392, 116 ), ImVec2( 346, 685 ), false, 2 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main 1     ", ImVec2( 28, 116 ), ImVec2( 352, 316 ), false, 3 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main 2        ", ImVec2( 392, 116 ), ImVec2( 346, 316 ), false, 3 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                 ", ImVec2( 28, 116 ), ImVec2( 352, 640 ), false, 5 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Additional  ", ImVec2( 392, 116 ), ImVec2( 346, 726 ), false, 5 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                     ", ImVec2( 28, 116 ), ImVec2( 352, 398 ), false, 6 ) );
            {
                ...
                ADD_ELEMENT ( C_Element ( ).Checkbox ( _h ( "CB_MOTION_PENIS" ), "Motion Blur", CHILD_ELEMENT_POS ( 7 ), &nem::hacks::g_aim_bot->cfg ( ).m_bMotionBlur ) );
            }
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                          ", ImVec2( 28, 116 ), ImVec2( 352, 387 ), false, 7 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main 2                             ", ImVec2( 392, 116 ), ImVec2( 346, 485 ), false, 7 ) );
            {
                ...
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_BOMB_INDICATOR" ), "Bomb indicator", CHILD_ELEMENT_POS( 3 ), &nem::hacks::g_aim_bot->cfg ( ).m_bBombIndicator ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_WATERMARK" ), "Watermark", CHILD_ELEMENT_POS( 4 ), &nem::hacks::g_aim_bot->cfg ( ).m_bWatermark ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_PRESERVE_KILLFEED" ), "Preserve Killfeed", CHILD_ELEMENT_POS( 5 ), &nem::hacks::g_aim_bot->cfg ( ).m_bPreserveKillfeed ) );
                ADD_ELEMENT( C_Element( ).Checkbox( _h( "CB_BUYBOT" ), "BuyBot", CHILD_ELEMENT_POS( 6 ), &nem::hacks::g_aim_bot->cfg ( ).m_bBuyBot ) );

                ADD_ELEMENT( C_Element( ).Combo( _h( "CMB_BUYBOT_SNIPERS" ), "Snipers", CHILD_ELEMENT_POS( 7 ), { "None", "Auto", "AWP", "SSG 08" }, & nem::hacks::g_aim_bot->cfg ( ).m_iBuyBotSnipers ) );
                ADD_ELEMENT( C_Element( ).Combo( _h( "CMD_BUYBOT_PISTOLS" ), "Pistols", CHILD_ELEMENT_POS( 8 ), { "None", "Dual Berettas", "Deagle/R8" }, & nem::hacks::g_aim_bot->cfg ( ).m_iBuyBotPistols ) );

                ADD_ELEMENT( C_Element( ).MultiCombo( _h( "MCMB_BUYBOT_ADDITIONAL" ), "Additional", CHILD_ELEMENT_POS( 9 ), { "Grenades", "Armor", "Taser", "Defuser" }, & nem::hacks::g_aim_bot->cfg ( ).m_iBuyBotAdditional ) );
            }
            ADD_ELEMENT( C_Element( ).ChildEnd( false, 7 ) );
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                                             ", ImVec2( 28, 116 ), ImVec2( 352, 162 ), false, 8 ) );
            {
            ...
            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                                   ", ImVec2( 28, 116 ), ImVec2( 352, 245 ), false, 9 ) );
            {
                ...
                ADD_ELEMENT( C_Element( ).Button( "Open cfg folder", CHILD_ELEMENT_POS( 3 ), ImVec2( 140.f, 30.f ), OnOpenCfgFolder ) );
            }
            ADD_ELEMENT( C_Element( ).ChildEnd( false, 9 ) );

            m_iCurrentTabSetup = 10;

            ADD_ELEMENT( C_Element( ).ChildBegin( "Main                                       ", ImVec2( 28, 116 ), ImVec2( 352, 440 ), false, 10 ) );
            {
